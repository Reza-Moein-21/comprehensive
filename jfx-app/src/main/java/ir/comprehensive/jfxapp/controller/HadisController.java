...
import ir.comprehensive.domain.service.HadisService;
...
import ir.comprehensive.jfxapp.service.HadisFxService;
...
public class HadisController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        //        dlgLayout
        tblHadis.setItemPage(pageRequest -> hadisService.search(searchModel, pageRequest));
        tblHadis.refresh();
