...
public class ProductDeliveryFxModel extends BaseFxModel {
    ...
    private final ObjectProperty<WarehouseFxModel> product = new SimpleObjectProperty<>();
    ...
    private final ObjectProperty<LocalDate> deliveryDateFrom = new SimpleObjectProperty<>();
    private final ObjectProperty<LocalDate> deliveryDateTo = new SimpleObjectProperty<>();
    private final ObjectProperty<LocalDate> desiredDate = new SimpleObjectProperty<>();
    private final ObjectProperty<LocalDate> receivedDate = new SimpleObjectProperty<>();
    private final ObjectProperty<LocalDate> receivedDateFrom = new SimpleObjectProperty<>();
    private final ObjectProperty<LocalDate> receivedDateTo = new SimpleObjectProperty<>();
    private final ObjectProperty<ProductStatusEnum> status = new SimpleObjectProperty<>();
